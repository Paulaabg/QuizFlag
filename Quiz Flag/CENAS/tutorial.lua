...
function cena:create( event )
  ...
  local textoTutorial = display.newText(cenaTutorial, 'TUTORIAL', x*0.5, y*0.2, fonte, 170 )
  ...
  local botaoJogar = display.newRoundedRect(cenaTutorial, x*0.5, y*0.76, x*0.6, y*0.07, 180 )
